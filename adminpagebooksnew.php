	...
	?>
				<form id="form_registo" name="form_registo" method="POST" action="processarRegistoLivro.php">
					...
					<div>
						...
						<span><input type="text" class="textbox" name="livroNome" placeholder="insira o título do livro"></span>
					</div>
					<div>
						<span><label>Autor(es):</label></span>
						<span><input type="text" class="textbox" name="autorNome" placeholder="insira o(s) nome(s) do(s) autor(es)"></span>
					</div>
					<div>
					...
					<div>
						...
						<span><input type="text" class="short" name="exemplarNrs" placeholder="exemplares livro"></span>
					</div>
					<div class="clear"></div>
