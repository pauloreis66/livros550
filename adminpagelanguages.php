...
<?php
	...
	if(!empty(mysqli_num_rows($resultado))){
		...
		while($linha = mysqli_fetch_array($resultado)){
			$id = $linha["$campo1"];
			$nome = $linha["$campo2"];
			echo "<tr><td>" .$id. "</td><td>".$nome."</td><td><span><a href='adminpagelanguagesrec.php?id=".$id."&mode=edit'><img src='images/edit.png' alt='editar'>editar</a></span></td>";
		...
		echo "<a href='adminpagelanguagesnew.php'><img src='images/add.png' alt='novo'>novo registo</a></td>";
		echo "<td>Página:&nbsp;";
