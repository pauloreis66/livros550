...
<?php
	...
	$consulta = "SELECT idIdioma, Idioma FROM idiomas ORDER BY 2 ASC LIMIT $primeiroReg, $registosPagina";
	...
	if(!empty(mysqli_num_rows($resultado))){
		...
		while($linha = mysqli_fetch_array($resultado)){
			$id = $linha["$campo1"];
			$nome = $linha["$campo2"];
			echo "<tr><td>" .$id. "</td><td width='65%'>".$nome."</td>";
			echo "<td><span><a href='adminpagelanguagesrec.php?id=".$id."&mode=edit'><img src='images/edit.png' alt='editar'>editar</a></span></td>";
			echo "<td><span><a href='adminpagelanguagesrec.php?id=".$id."&mode=delete'><img src='images/trash.png' alt='eliminar'>eliminar</span></td></tr>";
		}
		echo "</table><br>";
		//-----navegação entre páginas
		echo "<table><tr><th>";
		echo "<a href='adminpagelanguagesnew.php'><img src='images/add.png' alt='novo'>novo registo</a></th>";
		echo "<th><img src='images/pages.png' alt='páginas'> Página:&nbsp;";
		//calcular o numero de registos e numero de paginas necessarias
		$sqlTodosReg = mysqli_query($ligacao, "SELECT * FROM idiomas ORDER BY Idioma ASC");
