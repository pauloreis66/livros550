    ...
    <div class="content">
    	<div class="section group">
			...
			<div class="col span_2_of_3">
				...
				<form id="form_registo" name="form_registo" method="POST" action="processarRegistoEditor.php">
				<!---
					<div>
				...
				--->
					<div>
						...
						<span><input type="text" class="textbox" name="editoraNome" placeholder="insira a descrição da Editora"></span>
					</div>
					<div>
						<span><label>URL:</label></span>
						<span><input type="text" class="textbox" name="editoraUrl" placeholder="insira a página web da Editora"></span>
					</div>
