    ...
    <div class="content">
    	<div class="section group">
			...
			<div class="col span_2_of_3">
				<h2>Registos de Devoluções</h2>
				<div class="clear"></div>
				<div class="gridtable">
					<p>Registos de devolução de livros efetuadas.</p>
					<table><tr><th>Req.</th><th>Data:</th><th>Livro:</th><th>Qtd.:</th><th>Estado:</th><th>Entrega:</th><th>Utilizador:</th></tr>
...
<?php
	...
	WHERE r.estado = 2 ORDER BY 1 ASC LIMIT $primeiroReg, $registosPagina";
	...
	if(!empty(mysqli_num_rows($resultado))) {
		...
		while($linha = mysqli_fetch_array($resultado)){
			...
			$nome = $linha["$campo7"];
			echo "<tr><td>" .$idR. "</td><td>".$dataR."</td><td>".$livro."</td><td>".$qtd."</td><td>".$estadolbl."</td><td>".$dataD."</td><td>".$nome."</td></tr>";

		}
		echo "</table><br>";
		//-----navegação entre páginas
		echo "<table><tr><th>";
		echo "<a href='adminpageslistarequisitarnew.php'><img src='images/add.png' alt='novo'>nova requisição</a></th>";
	...
	FROM requisicao AS r INNER JOIN utilizadores AS u ON r.idUser=u.idUser WHERE r.estado=2 ORDER BY 1");
