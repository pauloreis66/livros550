    ...
    <div class="content">
    	<div class="section group">
			...
			<div class="col span_2_of_3">
				<h2>Origem / Medidas de Financiamento >> Novo Registo</h2>
				<div class="clear"></div>
				<div class="reccord-form">
					<p>Digite os dados solicitados no campo seguinte.</p>
					<div class="clear"></div>
					<div class="clear"></div>
					
				<form id="form_registo" name="form_registo" method="POST" action="processarRegistoFinance.php">
				<!---
					<div>
				...
				--->
					<div>
						...
						<span><input type="text" class="textbox" name="origemNome" placeholder="insira a descrição da nova medida"></span>
					</div>
