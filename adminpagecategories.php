    ...
    <div class="content">
    	<div class="section group">
			...
			<div class="col span_2_of_3">
				...
				<div class="clear"></div>
				<div class="gridtable">
					<p><img src="images/grid.png" alt="Registos">&nbsp;Registos de categorias técnicas existentes no catálogo de livros.</p>
...
<?php
	...
	if(!empty(mysqli_num_rows($resultado))) {
		...
		while($linha = mysqli_fetch_array($resultado)){
			$id = $linha["$campo1"];
			$nome = $linha["$campo2"];
			echo "<tr><td>" .$id. "</td><td>".$nome."</td><td><span><a href='adminpagecategoriesrec.php?id=".$id."&mode=edit'><img src='images/edit.png' alt='editar'>editar</a></span></td>";
			echo "<td><span><a href='adminpagecategoriesrec.php?id=".$id."&mode=delete'><img src='images/trash.png' alt='eliminar'>eliminar</span></td></tr>";
		}
		echo "</table><br>";
		//-----navegação entre páginas
		echo "<table><tr><td align='center'>";
		echo "<a href='adminpagecategoriesnew.php'><img src='images/add.png' alt='novo'>novo registo</a></td>";
