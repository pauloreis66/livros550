    ...
    <div class="content">
		...
		<div class="section group">
			<div class="col span_2_of_3">
				...
				?>
				<table>
					<th colspan="2">Os seus dados pessoais</th>
					<tr><td>Nome:<br />Cargo:<br />Email:</td><td><?php echo $nome ?><br /><?php echo $cargo ?><br /><?php echo $email ?></td></tr>
					<tr><td colspan="2" align="right">
						<form method="POST" action="perfil.php">
							<input type="submit" name="perfil" value="Editar dados pessoais">
				...
				if ($resultado > 0) {
					while ($mostrar = mysqli_fetch_array($consulta)) {
						...
						echo "<form method='POST' action='finalizarequisitar2.php'>";
						echo "<input type='submit' name='submit' value='Concluir a requisição'>";
						echo "</form></td></tr>";
					}
					else {
