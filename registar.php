				  	...
				  	<h2><center>Registo de novo utilizador</center></h2>
					    <form name="form_login" method="POST" action="processarRegistar.php">
					    	...
					    	<div>
						    	...
						    	<span><input type="text" name="nome" id="nome" placeholder="Insira nome próprio e apelido"></span>
						    </div>
					    	<div>
						    ...
						    <div>
						    	...
						    	<span><input type="password" name="senha" id="senha"></span>
						    </div>
						    <div>
						    	<span><label>Repetir Palavra-passe</label></span>
						    	<span><input type="password" name="resenha" id="resenha"></span>
						    </div>
