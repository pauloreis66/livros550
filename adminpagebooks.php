...
<?php
	...
	$consulta = "SELECT idLivro, titulo, idCat, autor FROM livros1 ORDER BY 1 ASC LIMIT $primeiroReg, $registosPagina";
	...
	if(!empty(mysqli_num_rows($resultado))){
		...
		$sqlTodosReg = mysqli_query($ligacao, "SELECT * FROM livros1 ORDER BY 1 ASC");
