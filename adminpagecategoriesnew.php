    ...
    <div class="content">
    	<div class="section group">
			...
			<div class="col span_2_of_3">
				<h2>Categorias Técnicas >> Novo Registo</h2>
				<div class="clear"></div>
				...
				<form id="form_registo" name="form_registo" method="POST" action="processarRegistoCat.php">
				<!---
					<div>
				...
				--->
					<div>
						...
						<span><input type="text" class="textbox" name="categoriaNome" placeholder="insira a descrição da nova categoria"></span>
					</div>
