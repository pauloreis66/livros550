    ...
    <div class="content">
    	<div class="section group">
			...
			<div class="col span_2_of_3">
				...
				<form id="form_registo" name="form_registo" method="POST" action="processarRegistoLanguages.php">
				<!---
					<div>
				...
				--->
					<div>
						...
						<span><input type="text" class="textbox" name="idiomaNome" placeholder="insira a descrição do novo idioma"></span>
					</div>
